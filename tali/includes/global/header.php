...
if (isset($_SESSION['username'])) {
	echo "
			<div>
				...
				<p class=\"tali-header-account\">Logged in as ".$_SESSION['username']." (<a href=\"".TALI_DOMAIN_URL."".TALI_URI."/account.php\">Account</a>) (<a href=\"".TALI_DOMAIN_URL."".TALI_URI."/login.php\">Log Out</a>)</p>
			</div>
	";
}
